...
function theme_enqueue_styles() {
    ...
    //  les scripts de manière différée avec l'attribut "defer"
    wp_enqueue_script( 'swiper-element-bundle.min', get_theme_file_uri( '/assets/js/swiper-bundle.min.js'), array(), '10.1.0', true );
    wp_enqueue_script( 'order-custom-scripts', get_theme_file_uri( '/assets/js/custom.js' ), array('jquery'), '1.0.0', true );
}

//  les options de personnalisation du thème parent vers le thème enfant
